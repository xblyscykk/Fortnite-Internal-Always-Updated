...
void itsjustai() {
	...
	ue::cached::signatures::FreeFn = sdkUssage->PatternScan(ue::cached::Base, e("48 89 D1 48 FF 25 ? ? ? ? C3"), 0, false);
	...
	ue::cached::signatures::LineSightOfTo = sdkUssage->PatternScan(ue::cached::Base, e("48 8B C4 48 89 58 20 55 56 57 41 54 41 56 48 8D 68 B8 48 81 EC ?? ?? ?? ??"), 0, false);;
